...
function BlockDomain {
    ...
    Set-HostedContentFilterPolicy -Identity "Spam Block List" -BlockedSenderDomains @{Add=$dom}
    Set-HostedContentFilterPolicy -Identity default -BlockedSenderDomains @{Add=$dom}
...
function BlockSender {
    ...
    Set-HostedContentFilterPolicy -Identity "Spam Block List" -BlockedSenderDomains @{Add=$send}
    Set-HostedContentFilterPolicy -Identity default -BlockedSenderDomains @{Add=$send}
