...
Function CheckIn-AllDocuments([String]$SiteURL)
{
    Try{
        ...
        $Ctx.Credentials = Connect-SPOService - 
...
#Config Parameters
$SiteURL="https://becpconcept.sharepoint.com/sites/BECP"
  
#Setup Credentials to connect
$Cred= Get-Credential
$Credentials = Connect-SPOService -Url "https://becpconcept-admin.sharepoint.com"
