...
#	$UserCredential = Get-Credential
	...
	[DateTime]$startDate = "02/10/2022 00:00" #Format: mm/dd/yyyy hh:MM
	[DateTime]$endDate = "04/12/2022 23:59" #Format: mm/dd/yyyy hh:MM
	$SpecifiedUserIDs = "adm_jhoez@liberalforum.eu" #syntax: "<value1>","<value2>",..."<valueX>".
